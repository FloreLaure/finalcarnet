# Generated by Django 4.1.1 on 2022-12-01 10:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('person', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='carnet.user')),
            ],
        ),
        migrations.CreateModel(
            name='vaccinal',
        ...
        migrations.CreateModel(
            name='carnetUser',
            fields=[
                ('UserProfil', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='carnet.userprofil')),
                ('autre', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='carnet.autre')),
